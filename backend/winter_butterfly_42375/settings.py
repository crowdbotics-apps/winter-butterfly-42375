"""
Django settings for winter_butterfly_42375 project.
...
ROOT_URLCONF = 'winter_butterfly_42375.urls'
...
WSGI_APPLICATION = 'winter_butterfly_42375.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "winter_butterfly_42375 API",
    "DESCRIPTION": "API documentation for winter_butterfly_42375 App",
    "VERSION": "v1",
}
